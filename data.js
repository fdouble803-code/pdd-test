const allTickets = {
    "1": [
        ...
        { "ticket": 1, "id": 7, "question": "Sanab o'tilgan qaysi hollarda egiluvchan ulagichda shatakka olish taqiqlanadi?", "image": "no_image", "options": ["Faqat tog'li yo'llarda", "Yo'l yaxmalak, sirpanchiq bo'lgan hollarda", "Kuning qorong'i vaqtida va etarli ko'rinmaslik sharoitida", "Barcha sanab o'tilgan hollarda"], "answer": 1 },
    ...
    "2": [ // Исправлена структура открытия второго билета
        {
            "ticket": 2,
            "id": 1,
        ...
        },
        {
            ...
            "image": "no_image",
            "options": ["Transport vositasini zudlik bilan to'xtatishi, avariya ishoratlarini yoqishi va avariya to'xtash belgisini o'rнатishi", "Zudlik bilan tez yordam yoki militsiya chaqirishi", "Yo'lovchilarni tushirishi va harakatni davom ettirishi"],
            "answer": 0
        }
    ]
};
